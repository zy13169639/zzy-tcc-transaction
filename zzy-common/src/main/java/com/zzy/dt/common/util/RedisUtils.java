...
public class RedisUtils {
     ...
     */
    public static Boolean setIfAbsent(String key, String value, Long expired, TimeUnit timeUnit) {
        Boolean success = stringRedisTemplate.opsForValue().setIfAbsent(key, value, expired, timeUnit);
        return success;
    }
     ...
     * @return: org.springframework.data.redis.core.script.RedisScript<T>
     */
    public static <T> RedisScript<T> getScript(String filePath, Class<T> returnType) {
     ...
     * @return: T
     */
    public static <T> T executeScript(String filePath, Class<T> returnType, List<String> keys, Object... args) {
        return stringRedisTemplate.execute(getScript(filePath, returnType), keys, args);
    }
